...
- (void)viewDidLoad
{
  ...
  [self.navigationController.navigationBar setTranslucent:NO];
    ...
    self.drinks = @[[[Drink alloc] initWithName:@"Cola" categoryID:2 price:@2.50 andID:0 withImage:@"Images.xcassets%d/coca%d/coca%d" ofType:@"png"],[[Drink alloc]initWithName:@"Cola Light" categoryID:2 price:@2.50 andID:1 withImage:@"Images.xcassets%d/Cola_Light%d/Cola_Light%d" ofType:@"png"],[[Drink alloc] initWithName:@"Fanta" categoryID:2 price:@2.50 andID:2 withImage:@"Images.xcassets%d/Fanta%d/fanta%d" ofType:@"png"],[[Drink alloc] initWithName:@"7 UP" categoryID:2 price:@2.50 andID:3 withImage:@"Images.xcassets%d/7-up%d/7-up%d" ofType:@"png"],[[Drink alloc] initWithName:@"Ice Tea" categoryID:2 price:@3.50 andID:4 withImage:@"Images.xcassets%d/IceTea%d/IceTea%d" ofType:@"png"],[[Drink alloc] initWithName:@"Heineken Fles" categoryID:1 price:@3.75 andID:5 withImage:@"Images.xcassets%d/Bier_Fles%d/bierfles%d" ofType:@"png"], [[Drink alloc] initWithName:@"Pils" categoryID:1 price:@2.75 andID:6 withImage:@"Images.xcassets%d/Bier_Glas%d/bierglas%d" ofType:@"png"], [[Drink alloc] initWithName:@"Corona" categoryID:1 price:@4.25 andID:7 withImage:@"Images.xcassets%d/Corona%d/corona%d" ofType:@"png"],[[Drink alloc] initWithName:@"Radler" categoryID:1 price:@4.00 andID:8 withImage:@"Images.xcassets%d/Radler%d/radler%d" ofType:@"png"], [[Drink alloc] initWithName:@"Rose" categoryID:0 price:@3.75 andID:9 withImage:@"Images.xcassets%d/Rose%d/rose%d" ofType:@"png"],[[Drink alloc] initWithName:@"Fristi" categoryID:3 price:@2.50 andID:11 withImage:@"Images.xcassets%d/Fristi%d/Fristi%d" ofType:@"png"],[[Drink alloc] initWithName:@"Chocomel" categoryID:3 price:@2.50 andID:10 withImage:@"Images.xcassets%d/Chocomel%d/Chocomel%d" ofType:@"png"]];
